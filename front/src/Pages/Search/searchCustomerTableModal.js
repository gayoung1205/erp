...
const SearchCustomerTableModal = (props) => {
  ...
  return (
    <>
      <Modal
        ...
        zIndex={1030}
      >
        <SearchCustomerTable count={count} tables={props.tables} tags={props.tags} handleCancel={handleCancel} />
      </Modal>
    </>
  );
};

export default SearchCustomerTableModal;
