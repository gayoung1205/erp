...
export default [
  ...
  { name: 'completed_content', header: '거래내역/완료내역', sortable: true, align: 'center', ellipsis: true,
    formatter({ value }) {
      return `${value.split('택배비',2)}`;
    },
   },
   { name: 'content', header: '접수내용/메모', sortable: true, align: 'center', ellipsis: true,},
  {
    name: 'bank',
    header: '은행입금',
    sortable: true,
