export default {
  ...
  basename: '/aisol', // only at build time to set, like /aisol
  ...
  backEndServerAddress: 'http://127.0.0.1:8000/', // TestBackEndServer : 'http://192.168.0.254:8000/', BackEndServer : 'http://222.102.242.115:8000/'
};
